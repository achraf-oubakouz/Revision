<?php
    //1-
    $employes = [
        ["nom" => "Achraf", "poste" => "Développeur", "salaire" => 9000],
        ["nom" => "Sara", "poste" => "Comptable", "salaire" => 5000],
        ["nom" => "Mohamed", "poste" => "Technicien", "salaire" => 4000],
        ["nom" => "Soufiane", "poste" => "Comptable", "salaire" => 5000],
        ["nom" => "Reda", "poste" => "Technicien", "salaire" => 4000]
    ];
